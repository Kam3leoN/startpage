...
/** Show week celebrations sheet (opened from nav). */
export const DEFAULT_SHOW_WEEK_CELEBRATIONS = false;
export const SHOW_WEEK_CELEBRATIONS_KEY = "k3-show-week-celebrations";

/** @deprecated Position of the old floating card — no longer used. */
